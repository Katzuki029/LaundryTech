...
<div class="container-fluid">
	<form action="" id="manage-laundry" method="post">
		<div class="col-lg-12">	
			...
			<div class="row">
				...
				<?php endif; ?>				
					...
					<div class="col-md-6">	
						<div class="form-group">	
							<label for="" class="control-label">Contact Number</label>
							<input type="text" class="form-control" name="customer_contact" value="<?php echo $showContacts['contact']?>">					
						</div>
					</div>
					<?php endif; ?>
					<!-- /contact number -->
			...
			<div class="col-md-6">
					<div class="form-group">
							<label for="" class="control-label">Washing Machine</label>
							<select name="washing" id="" class="custom-select browser-default">
							<option selected diasbled hidden>--Select Washing Machine--</option>
								<?php 
								// $sql = "SELECT * FROM washing_list WHERE status='Active'";
								$sql = "SELECT * FROM washing_list WHERE status='Active'";
								$list = $conn->query($sql) or die($conn->error);
